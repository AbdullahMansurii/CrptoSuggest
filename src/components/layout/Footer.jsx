        ...
        <footer className="bg-primary-dark text-white mt-20">
            <div className="container-custom py-12">
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                    {/* About */}
                    <div>
                        <h4 className="font-bold text-lg mb-4 text-accent">About Crypto Suggest</h4>
                    ...
                    {/* Categories */}
                    <div>
                        <h4 className="font-bold text-lg mb-4 text-accent">Popular Categories</h4>
                        <ul className="space-y-2">
                            {categories.map(cat => (
                                <li key={cat.path}>
                                    <Link to={cat.path} className="text-white/70 hover:text-accent text-sm transition-colors">
                                        {cat.name}
                                    </Link>
                                </li>
                            ))}
                    ...
                    {/* For Website Owners */}
                    <div>
                        <h4 className="font-bold text-lg mb-4 text-accent">For Website Owners</h4>
                        <ul className="space-y-2">
                            <li><Link to="/submit" className="text-white/70 hover:text-accent text-sm transition-colors">Submit Website</Link></li>
                            <li><Link to="/about" className="text-white/70 hover:text-accent text-sm transition-colors">Verification Process</Link></li>
                            <li><Link to="/contact" className="text-white/70 hover:text-accent text-sm transition-colors">Contact Us</Link></li>
                        </ul>
                    </div>
                    ...
                    <div>
                        ...
                        <ul className="space-y-2">
                            <li><Link to="/about" className="text-white/70 hover:text-accent text-sm transition-colors">About Us</Link></li>
                            <li><Link to="/contact" className="text-white/70 hover:text-accent text-sm transition-colors">FAQ</Link></li>
                            <li><Link to="/contact" className="text-white/70 hover:text-accent text-sm transition-colors">Contact</Link></li>
                        </ul>
